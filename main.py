'''
KeyAuth.ru Python Example

Go to https://keyauth.ru/app/ and click the Python tab. Copy that code and replace the existing keyauthapp instance in this file.

If you get an error saying it can't find module KeyAuth, try following this https://github.com/keyauthru/KeyAuth-Python-Example#how-to-compile
...
READ HERE TO LEARN ABOUT KEYAUTH FUNCTIONS https://github.com/keyauthru/KeyAuth-Python-Example#keyauthapp-instance-definition
'''
